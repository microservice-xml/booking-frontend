  ...
  return (
    <div className="registration-container">
      <div className="registration-container__inside">
        <div className="registration-container__inside__label">First Name:</div>
        ...
        <div className="registration-container__inside__label">Last Name:</div>
        <div className="registration-container__inside__text">
          <input
            className="registration-container__inside__text__content"
            type="text"
        ...
        <div className="registration-container__inside__label">Email:</div>
        <div className="registration-container__inside__text">
          <input
            className="registration-container__inside__text__content"
            type="text"
        ...
        <div className="registration-container__inside__label">Username:</div>
        <div className="registration-container__inside__text">
          <input
            className="registration-container__inside__text__content"
            type="text"
        ...
        <div className="registration-container__inside__label">Password:</div>
        <div className="registration-container__inside__text">
          <input
            className="registration-container__inside__text__content"
            name="password"
